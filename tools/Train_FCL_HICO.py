...
def parse_args():
    ...
    parser.add_argument('--model', dest='model',
             help='Select model: '
                  'open long-tailed FCL: FCL_resnet101_union_l2_zs_s0_vloss2_varl_gan_dax_rands_aug5_xnew,'
                  'open long-tailed baseline: FCL_resnet101_base_union_l2_zs_s0_vloss2_aug5_xnew'
                        'rare-first zero-shot:FCL_resnet101_union_l2_zsrare_s0_vloss2_varl_gan_dax_rands_aug5_xnew'
                        'non-rare-first zero-shot:FCL_resnet101_union_l2_zsnrare_s0_vloss2_varl_gan_dax_rands_aug5_xnew'
                        'you can also use FCL_resnet101_union_l2_zs_s0_vloss2_var_gan_dax_rands_aug5_xnew',
...
if __name__ == '__main__':
    ...
    image, image_id, num_pos, Human_augmented, Object_augmented, action_HO, sp, obj_mask = obtain_data(
        ...
        zero_shot_type=zero_shot_type, epoch=start_epoch, neg_type=neg_type_ratio)
